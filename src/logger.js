...
var Logger = function (levelIn) {
    ...
    if (this.isValidLevel(this.level) === false) {
        throw "logging requires a valid log level, got: " + this.level;
    }
    this.new("internal setup", false);
...
Logger.prototype.log = function (msg, level) {
    ...
    if (this.isValidLevel(level) === false) {
        throw "logging requires a valid log level, got: " + level + " for message: " + msg;
    }
